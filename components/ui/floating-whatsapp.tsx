...
export function FloatingWhatsApp() {
  const whatsappNumber = '917665629448';
  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-[9999] pointer-events-auto">
      ...
      <Button
        ...
        className="h-16 w-16 rounded-full bg-green-500 hover:bg-green-600 shadow-2xl hover:shadow-2xl transition-all duration-300 p-0 flex items-center justify-center border-4 border-white"
